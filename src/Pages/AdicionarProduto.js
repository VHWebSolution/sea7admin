    ...
    const [produto, setProduto] = useState({
      ...
      const handleSubmit = async (event) => {
        ...
        try {
          ...
          const response = await axios.post('https://www.sea7api.com.br/salvar', formData, {
            headers: {
  ...
  return (
    ...
    <div className='flex justify-center items-center min-h-screen px-4'>
      <div className='class="bg-white p-6 md:p-10 w-full md:w-1/2 rounded-md shadow-md border-gray-200 border-[5px] flex flex-col md:flex-row'>
        ...
        <div className='w-2/3 ss:w-1/3 mt-4'>
        <div className='grid'>
            ...
            <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50'>
                ...
                <div className='flex flex-wrap py-2 justify-center items-center'>
                    ...
                    <img
                        ...
                        src={URL.createObjectURL(file)}
                        alt={`Secondary Preview ${index + 1}`}
                        className={`max-w-[35px] h-[35px] cursor-pointer m-1 ${
                        selectedImageIndex === index ? 'border-2 border-s7green' : ''
                        }`}
